...
def test_inner_sample_refreshes_nested_shapes_after_outer_geometry_change():
    ...
    packed_source_elements = sum(math.prod(shape[1:]) for shape in source_shapes)
    latent_image = torch.ones(1, 1, packed_source_elements)
